          ...
          <el-row :gutter="20">
            <el-col :span="6">
              <el-form-item label="机构编码：">
                <el-input v-model="poor.bankCode" placeholder="请填写户主姓名" size="mini"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="月份：">
                <el-select
                  ...
                  class="widthAuto"
                >
                  <el-option :label="item.label" :value="item.value" v-for="(item,index) in itme" :key="index"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            <el-col :span="6">
...
<script>
import { waringPoor } from "@/api/StatisticalAnalysis";
...
export default {
  ...
  methods: {
    // 搜索
    onSubmit() {
      this.poor.currentPageNum = this.currentPage
      this.tableLoading = true;
      waringPoor(this.poor)
        .then(res => {
          if (res.code == "00000") {
